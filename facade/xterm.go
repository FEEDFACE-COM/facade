...
func lookupMode(val string) string {
	...
	case "1":
		return "GUARDED AREA TRANSFER MODE"
	case "2":
		return "KEYBOARD ACTION MODE"
	case "3":
		return "CONTROL REPRESENTATION MODE"
	case "4":
		return "INSERTION REPLACEMENT MODE"
	case "5":
		return "STATUS REPORT TRANSFER MODE"
	case "6":
		return "ERASURE MODE"
	case "7":
		return "LINE EDITING MODE"
	case "8":
		return "BI-DIRECTIONAL SUPPORT MODE"
	case "9":
		return "DEVICE COMPONENT SELECT MODE"
	case "10":
		return "CHARACTER EDITING MODE"
	case "11":
		return "POSITIONING UNIT MODE"
	case "12":
		return "SEND/RECEIVE MODE"
	case "13":
		return "FORMAT EFFECTOR ACTION MODE"
	case "14":
		return "FORMAT EFFECTOR TRANSFER MODE"
	case "15":
		return "MULTIPLE AREA TRANSFER MODE"
	case "16":
		return "TRANSFER TERMINATION MODE"
	case "17":
		return "SELECTED AREA TRANSFER MODE"
	case "18":
		return "TABULATION STOP MODE"
	case "21":
		return "GRAPHIC RENDITION COMBINATION"
	case "22":
		return "ZERO DEFAULT MODE"
