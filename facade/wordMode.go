...
func (mode *WordMode) Render(camera *gfx.Camera, font *gfx.Font, debug, verbose bool) {
	...
	mode.program.VertexAttribPointer(gfx.VERTEX, 3, (3+2+1+1+1+1)*4, (0)*4)
	mode.program.VertexAttribPointer(gfx.TEXCOORD, 2, (3+2+1+1+1+1)*4, (0+3)*4)
	mode.program.VertexAttribPointer(CHARINDEX, 1, (3+2+1+1+1+1)*4, (0+3+2)*4)
	mode.program.VertexAttribPointer(WORDINDEX, 1, (3+2+1+1+1+1)*4, (0+3+2+1)*4)
	mode.program.VertexAttribPointer(WORDWIDTH, 1, (3+2+1+1+1+1)*4, (0+3+2+1+1)*4)
	mode.program.VertexAttribPointer(WORDLENGTH, 1, (3+2+1+1+1+1)*4, (0+3+2+1+1+1)*4)
